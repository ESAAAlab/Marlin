...
#define STRING_CONFIG_H_AUTHOR "(melka, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_WASP2040_31
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "WASP 2040"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "3298c17e-1959-4368-99af-676d8ea84de4"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 294.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 445.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 175.60              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85.33, 85.33, 85.33, 104.70 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define DEFAULT_RETRACT_ACCELERATION  20000   // E acceleration for retracts
